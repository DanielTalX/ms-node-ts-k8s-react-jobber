import { ISellerDocument } from '@danieltalx/jobber-shared';
import { MsSchemaNames } from '@users/enums';
...
const SellerModel: Model<ISellerDocument> = model<ISellerDocument>(MsSchemaNames.Seller, sellerSchema, MsSchemaNames.Seller);
export { SellerModel };