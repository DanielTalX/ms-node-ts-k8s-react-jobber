...
import { BadRequestError, IAuthDocument, IEmailMessageDetails } from '@danieltalx/jobber-shared';
...
export async function forgotPassword(req: Request, res: Response): Promise<void> {
  ...
  const messageDetails: IEmailMessageDetails = {
    ...
    template: MsEmailTypes.forgotPassword
  };
...
export async function resetPassword(req: Request, res: Response): Promise<void> {
  ...
  const messageDetails: IEmailMessageDetails = {
    username: existingUser.username,
    template: MsEmailTypes.resetPasswordSuccess
  };
  await publishDirectMessage(
    authChannel,
    MsExchangeNames.JobberEmailNotification,
