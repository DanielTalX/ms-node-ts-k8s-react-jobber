...
import { BadRequestError, IAuthDocument, IEmailMessageDetails, firstLetterUppercase, lowerCase, uploads } from '@danieltalx/jobber-shared';
...
export async function create(req: Request, res: Response): Promise<void> {
  ...
  await uploads(profilePicture, `${profilePublicId}`, true, true) as UploadApiResponse :
  { profilePicture, public_id: 'public_id_test', secure_url: 'secure_url_test' } as any;
