...
import { IPaginateProps, ISearchResult } from '@danieltalx/jobber-shared';
import { Request, Response } from 'express';
import { sortBy } from 'lodash';
import { StatusCodes } from 'http-status-codes';
import { MsElasticIndexes } from '@auth/enums';
...
export async function singleGigById(req: Request, res: Response): Promise<void> {
  const gig = await gigById(MsElasticIndexes.gigs, req.params.gigId);
