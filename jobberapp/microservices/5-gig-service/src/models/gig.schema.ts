import { ISellerGig } from '@danieltalx/jobber-shared';
import { MsSchemaNames } from '@gig/enums';
...
const GigModel: Model<ISellerGig> = model<ISellerGig>(MsSchemaNames.Gig, gigSchema, MsSchemaNames.Gig);
export { GigModel };