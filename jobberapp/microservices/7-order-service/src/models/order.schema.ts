import { IOrderDocument } from '@danieltalx/jobber-shared';
import { MsSchemaNames } from '@order/enums';
...
const OrderModel: Model<IOrderDocument> = model<IOrderDocument>(MsSchemaNames.Order, orderSchema, MsSchemaNames.Order);
export { OrderModel };