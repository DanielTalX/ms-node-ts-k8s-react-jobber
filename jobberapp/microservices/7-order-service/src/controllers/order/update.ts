...
import { BadRequestError, IDeliveredWork, IOrderDocument, uploads } from '@danieltalx/jobber-shared';
...
// in https://dashboard.stripe.com/settings/emails enable Payments under Customer emails
